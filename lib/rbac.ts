...
export const ROUTE_RULES: RouteRule[] = [
  ...
  { prefix: "/dashboard/inventory/products", roles: ["ADMIN", "SUPERADMIN"], description: "Daftar Produk" },
  { prefix: "/dashboard/inventory/rejects", roles: ["ADMIN", "SUPERADMIN"], description: "Reject (admin view)" },
  { prefix: "/dashboard/inventory", roles: ["ADMIN", "SUPERADMIN", "GUDANG"], description: "Warehouse overview - admin & gudang" },
  ...
  { prefix: "/dashboard/transfer/warehouses", roles: ["ADMIN", "SUPERADMIN"], description: "Setup Gudang" },
